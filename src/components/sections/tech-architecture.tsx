    ...
    <section className="relative overflow-hidden">
      <AmbientBackground variant="neutral" intensity="subtle" className="py-20 sm:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {techCards.map((card, i) => (
              <TiltCard key={card.title} tiltAmount={6} className="group rounded-2xl">
                ...
                >
                  ...
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-green-500 to-green-700 text-white shadow-lg shadow-green-900/15">
                  ...
                  <span className="mt-4 inline-block rounded-full bg-gradient-to-r from-green-100 to-green-50 px-3 py-1 text-xs font-bold text-green-900">
                    {card.tag}
                  </span>
                </motion.div>
              </TiltCard>
          ...
          {/* Workflow stepper */}
          <TiltCard tiltAmount={3} className="mt-12 rounded-3xl">
            <div className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-lg sm:p-10">
              <div className="mb-8 flex items-start gap-5">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-green-900 to-green-700 text-lg font-extrabold text-white shadow-lg shadow-green-900/20">
                  3.1
                </div>
                <div>
              ...
              <div className="relative mb-10 flex justify-between">
                ...
                <div className="absolute left-4 right-4 top-5 hidden h-0.5 origin-left bg-gradient-to-r from-green-900 to-green-600 md:block" style={{ transform: `scaleX(${step / (workflowSteps.length - 1)})` }} />
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        step === i
                          ? "border-green-900 bg-gradient-to-br from-green-900 to-green-700 text-white shadow-[0_0_0_6px_rgba(27,67,50,0.15)]"
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {workflowSteps[step].metrics.map((m, idx) => (
                        <div
                          key={m.label}
                          className={cn(
                            "flex items-center justify-between rounded-lg px-3 py-2 text-sm transition-colors hover:bg-green-50/60",
