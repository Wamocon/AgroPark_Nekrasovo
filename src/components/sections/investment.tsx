    ...
    <div ref={ref} className="flex items-center gap-4">
      ...
      <div className="flex-1 overflow-hidden rounded-lg bg-neutral-200">
        <motion.div
          ...
          className={`h-8 bg-gradient-to-r ${color} flex items-center justify-end pr-3 text-xs font-bold text-white`}
        >
          {display}
        </motion.div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <motion.div
            ...
            className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-green-900 to-green-800 p-8 text-white"
          >
            ...
            <div className="relative">
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                {features.map((feature) => (
                  <div
                    key={feature}
                    className="flex items-center gap-2 rounded-lg bg-white/10 px-4 py-3 text-sm"
                  >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="mt-10 rounded-3xl border border-neutral-200 bg-white p-6 sm:p-10"
        >
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-green-900 to-green-800 p-6 text-center text-white">
