  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: "assistant",
      content:
        "Hallo! Ich bin der KI-Assistent von AgroPark Nekrasovo. Wie kann ich Ihnen helfen?",
    },
  ]);
    ...
    <>
          ...
          >
            <div className="flex items-center justify-between bg-gradient-to-r from-green-900 to-green-800 px-4 py-3 text-white">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-sm font-bold">AgroPark KI</div>
                  <div className="text-[10px] opacity-80">Antwortet in Sekunden</div>
                </div>
              </div>
              <button
            ...
            >
              ...
              {loading && (
                <div className="flex w-max max-w-[85%] items-center gap-2 rounded-2xl rounded-bl-none bg-neutral-100 px-3 py-2 text-sm text-foreground">
                  ...
                  <span className="text-xs text-neutral-600">Denkt nach...</span>
                </div>
              )}
              {error && (
      ...
      {!open && (
        <motion.button
          ...
          className="fixed bottom-6 right-6 z-[60] flex h-14 w-14 items-center justify-center rounded-full bg-green-900 text-white shadow-lg shadow-green-900/30 hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
