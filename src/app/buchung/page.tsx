...
import { Calendar, Ticket, Check, ArrowRight } from "lucide-react";
              ...
              <Card className="border-green-200 bg-green-50">
                ...
                <CardContent className="space-y-6">
                  <div className="mx-auto h-48 w-48 rounded-xl border-4 border-white bg-white p-2 shadow-sm">
                    <div className="flex h-full w-full items-center justify-center rounded-lg bg-neutral-100 text-xs text-neutral-500">
                      QR-Code
                    </div>
                  </div>
