...
export default function LoginPage() {
 ...
 <h1 className="text-2xl font-semibold leading-none tracking-tight">Anmelden</h1>
 <CardDescription>
 ...
 <Link href="/" className="inline-flex min-h-10 items-center px-2 text-green-700 hover:underline">
